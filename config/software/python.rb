...
if ohai['platform'] != 'windows'
  ...
  build do
    ...
    command "copy C:\\python-omnibus\\python.exe #{install_dir}\\embedded\\bin\\python.exe"
    command "copy C:\\python-omnibus\\pythonw.exe #{install_dir}\\embedded\\bin\\pythonw.exe"
